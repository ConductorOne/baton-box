...
func cmdFlags(cmd *cobra.Command) {
	cmd.PersistentFlags().String("client-id", "", "Client ID used to authenticate to the Box API. ($BATON_CLIENT_ID)")
	cmd.PersistentFlags().String("client-secret", "", "Client Secret used to authenticate to the Box API. ($BATON_CLIENT_SECRET)")
